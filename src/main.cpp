...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8bcdcbeea50bac7fcd0b639aa3c04457fc830551cce5edc170dc83c78a5f80bb");
    }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Shiacoin: increase each by adding 2 to bitcoin's value.
